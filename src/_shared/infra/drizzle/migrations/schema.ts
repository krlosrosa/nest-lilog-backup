import { pgTable, index, foreignKey, serial, timestamp, text, uniqueIndex, integer, boolean, numeric, doublePrecision, date, varchar, jsonb, real, unique, primaryKey, pgView, interval, bigint, json, pgEnum } from "drizzle-orm/pg-core"
